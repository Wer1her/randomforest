# -*- coding: utf-8 -*-
"""
Created on Sat Jan 23 00:42:20 2021
...
y_train = ｄｆ1[u'ガス使用量'].values.tolist()
data_train = df1.drop([u'計測日時', u'水使用量', u'使用電力量', u'ガス使用量', u'太陽光発電(PV1)', u'外部発電', u'日照時間(時間)', u'平均風速(m/s)', u'月日'], axis=1)
x_train = data_train.values.tolist()
df2 = pd.read_csv('estimate.csv', encoding="cp932")
y_test = ｄｆ2[u'ガス使用量'].values.tolist()
data_test = df2.drop([u'計測日時', u'水使用量', u'使用電力量', u'ガス使用量', u'太陽光発電(PV1)', u'外部発電', u'日照時間(時間)', u'平均風速(m/s)', u'月日'], axis=1)
